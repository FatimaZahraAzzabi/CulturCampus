...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Admin | cultur campus</title>
       <!-- 
    - favicon
  -->
      <!-- Favicon -->
...
<div class="row">
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no">visiteurs   </p>
                    <p class="head_couter"><?php echo nombre_vue(); ?></p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_podcast ;?></p>
                    <p class="head_couter">Total podcast</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_pr; ?></p>
                    <p class="head_couter">Total Programme</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_episode; ?></p>
                    <p class="head_couter">Total épisodes</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_views_podcast; ?></p>
                    <p class="head_couter">Total Vues (Podcast)</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_likes_podcast; ?></p>
                    <p class="head_couter">Total Likes (Podcast)</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_v; ?></p>
                    <p class="head_couter">Total Vues (Épisodes)</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="full counter_section margin_bottom_30">
            ...
            <div class="counter_no">
                <div>
                    <p class="total_no"><?php echo $total_likes_episodes; ?></p>
                    <p class="head_couter">Total Likes (Épisodes)</p>
                </div>
            </div>
        </div>
    </div>
