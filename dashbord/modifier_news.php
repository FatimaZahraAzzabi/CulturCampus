...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $image = $row['image'];
        $date = $row['date_debut'];
        $date_f = $row['date_fin']; // c'est la date de 
        $title = $row['titre'];
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $uploadDir = '../img/news_images/' .$uploadFile;
            ...
            if(empty($_FILES['imageFile']['name'])){
                ...
                $updateSql = "UPDATE news SET titre = '$newTitle', date_fin='$date_f',description = '$newDescription', image = '$uploadFile' WHERE id_news = '$id_news'";
                $updateResult = mysqli_query($conn, $updateSql);
        
                if ($updateResult) {
                    echo '<script>alert("News modifiée avec succès.");</script>';
                    echo '<script>window.location.href = "afficher_news.php";</script>'; // Redirection après l'ajout
                    exit();
                } else {
                    echo '<script>alert("Erreur lors de la modification de la news. Veuillez réessayer.");</script>';
                }
            }
        }
    }
    ...
    <div class="inner_container">
        ...
        <div class="container">
            ...
            <form action="" method="POST" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    <label for="date_f">Date de suppression :</label>
                    <input type="text" class="form-control" id="date_f" name="date_f" value="<?php echo $date_f; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <img src="../img/news_images/<?php echo $image; ?>" class="img-fluid" style="width:100%;height:400px" alt="Image de l'actualité"><br><br>
                    <div class="field">
